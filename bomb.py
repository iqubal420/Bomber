...
def update():
    ...
    try:
        mainVersion = requests.get("https://raw.githubusercontent.com/Iqubal420/Bomber/main/more/.version").text
    except:
    ...
    os.system("cd .. && rm -rf Bomber && git clone https://github.com/Iqubal420/Bomber > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd Bomber && python bomb.py")
...
def logo():
    os.system("clear")
    print("""\t\t\033[97;1m
\t\t\033[96;1m _____         _____  _  __          _____
\t\t\033[96;1m  / ____|  /\   |  __ \| |/ /    /\   |  __ \
\t\t\033[96;1m | (___   /  \  | |__) | ' /    /  \  | |__) |
\t\t\033[96;1m \___ \ / /\ \ |  _  /|  <    / /\ \ |  _  /
\t\t\033[96;1m ____) / ____ \| | \ \| . \  / ____ \| | \ \
\t\t\033[96;1m |_____/_/    \_\_|  \_\_|\_\/_/    \_\_|  \_\
\t\t\033[1;90m════════════════════════════════════════════════
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mAuthor: Iqubal Sarkar
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mNICKNAME : SARKAR VAU
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : https://github.com/iqubal420
\t\t\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mCONTACT  : Facebook.com/sarkar.saheb420
\t\t\033[1;90m════════════════════════════════════════════════
\033[94;1m""")
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mSecDet Bomber\n")
        time.sleep(0.6)
